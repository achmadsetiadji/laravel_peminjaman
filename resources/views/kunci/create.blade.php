...
@section('title', 'Tambah Data Kunci')
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Kunci</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/kunci" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_kunci') is-invalid @enderror" id="nama_kunci"
                        placeholder="Masukan Nama Kunci" name="nama_kunci" value="{{ old('nama_kunci') }}">
                    @error('nama_kunci')
