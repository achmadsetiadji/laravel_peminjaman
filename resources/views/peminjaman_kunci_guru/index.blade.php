...
@section('title', 'Tabel Peminjaman Kunci Guru')
...
<div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$count_peminjaman_kunci_guru_pending}}</div>
                            </div>
                            <div class="col-auto">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Peminjaman Kunci Guru</h1>
        @if (auth()->user()->role_id == "1")
            <form class="form-inline">
                <a href="{{ url('/peminjamanKunciGuruexcel') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm mr-2">
                    <i class="fas fa-file-excel fa-md text-white-50"></i><span class="ml-2">Generate Excel</span>
                </a>
                <a href="{{ url('/peminjamanKunciGurupdf') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-lg-4" style="margin-left: -50px">
                                <form class="form-inline ml-3" method="GET" action="peminjaman_kunci_guru_sort_year">
                        ...
                        <div class="col-lg-4" style="margin-left: 100px">
                            <form class="form-inline" method="GET" action="peminjaman_kunci_guru_sort_month">
                                <div class="form-group">
                            ...
                            @foreach($peminjamankuncigurus as $peminjamanKunciGuru)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('peminjaman_kunci_guru.show', $peminjamanKunciGuru->id) }}">
                                            PMKG-{{ $peminjamanKunciGuru->id }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown mb-4">
                                            ...
                                            <div class="dropdown-menu animated--fade-in"
                                                ...
                                                @if ($peminjamanKunciGuru->status == 'Pending')
                                                    <form action="/peminjaman_kunci_guru/{{ $peminjamanKunciGuru->id }}"
                                                ...
                                                @elseif ($peminjamanKunciGuru->status == 'Dipinjam' or 'Dikembalikan')
                                                    <form action="/peminjaman_kunci_guru/{{ $peminjamanKunciGuru->id }}"
                                                        method="POST" class="d-inline">
                                                        @method('put')
                                                        @csrf
