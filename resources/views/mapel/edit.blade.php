...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Edit Mapel</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/mapel/{{ $mapel->id }}" method="POST">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_mapel') is-invalid @enderror" id="nama_mapel"
                        placeholder="Masukan Nama Mapel" name="nama_mapel" value="{{ $mapel->nama_mapel }}">
                    @error('nama_mapel')
