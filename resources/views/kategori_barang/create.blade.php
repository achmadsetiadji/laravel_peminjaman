...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Tambah Kategori Barang</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/kategori_barang" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror" id="nama_kategori"
                        placeholder="Masukan Nama Kategori" name="nama_kategori" value="{{ old('nama_kategori') }}">
                    @error('nama_kategori')
