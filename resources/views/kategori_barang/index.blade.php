...
@section('title', 'Tabel Kategori Barang')
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="/kategori_barang/create" class="text-primary">
                <i class="fas fa-plus"><span class="ml-2">Tambah Kategori Barang</span></i>
            </a>
        </div>
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $kategoribarang->nama_kategori }}</td>
                            <td class="text-center">
                                <a href="/kategori_barang/{{ $kategoribarang->id }}/edit" class="btn btn-small text-success">
                                    <i class="fa fa-edit"></i><span class="ml-2">Edit</span>
                                </a>
                                <form action="/kategori_barang/{{ $kategoribarang->id }}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
