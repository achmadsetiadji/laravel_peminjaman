...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Edit Guru</h6>
        </div>

        <div class="card-body">
            <form class=" form-signin" action="/guru/{{ $guru->id }}" method="POST">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" id="nama_guru"
                        placeholder="Masukan Nama Guru" name="nama_guru" value="{{ $guru->nama_guru }}">
                    @error('nama_guru')
